...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Tablas<br><small>Administrador de contenidos de "Fiesta Mexicana"</small></h1>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td>Consultar Ajuste</td>
                            <td><a class="btn btn-default" href="tablas/editCA.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Productos</td>
                            <td><a class="btn btn-default" href="tablas/editP.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Proveedores</td>
                            <td><a class="btn btn-default" href="tablas/edit.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Cancelar Venta</td>
                            <td><a class="btn btn-default" href="tablas/editCV.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Corte del dia</td>
                            <td><a class="btn btn-default" href="tablas/editCD.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Nueva venta</td>
                            <td><a class="btn btn-default" href="tablas/editNV.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Compra al proveedor</td>
                            <td><a class="btn btn-default" href="tablas/editCP.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Reportes</td>
                            <td><a class="btn btn-default" href="tablas/editR.php">Modificar</a>
                        </tr>
                        <tr>
                            <td>Ventas despues del corte</td>
                            <td><a class="btn btn-default" href="tablas/editVDC.php">Modificar</a>
                        </tr>
                        </table>
                </div>
                </div>
