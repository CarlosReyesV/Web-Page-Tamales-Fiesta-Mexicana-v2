            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" class="form-control" placeholder="Page Title" value="Nueva Venta">
                    </div>
                    <section class="tProductos" style="width:auto; min-width:none">
                        <?php
                        include("tablaNVadm.php");
                        ?>
                    </section>
                    </form>
                    <button><a type="button" href="../insertar/agregarNV.php">Agregar datos</a></button>
                </div>
                </div>
            </div>
            </div>
