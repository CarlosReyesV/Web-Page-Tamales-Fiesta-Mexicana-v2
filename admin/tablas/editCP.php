            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" class="form-control" placeholder="Page Title" value="Compra al proveedor">
                    </div>
                    <section class="tProductos" style="width:auto; min-width:none">
                        <?php
                        include("tablaCPadm.php");
                        ?>
                    </section>
                    </form>
                    <button><a type="button" href="../insertar/agregarCP.php">Agregar datos</a></button>
                </div>
                </div>
            </div>
            </div>
