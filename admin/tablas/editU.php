    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="../admin/SalirA.php">Página de usuario</a></li>
            </ul>
        ...
        <div class="container">
            <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Editar Usuario<small>Administrador de contenidos de "Fiesta Mexicana"</small></h1>
            </div>
            <div class="col-md-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a type="button" data-toggle="modal" data-target="#addPage">Agregar Tabla</a></li>
            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" class="form-control" value="Hugo Anguiano">
                    </div>
                    <div class="form-group">
                        <label>Contraseña</label>
                        <input type="text" class="form-control" value="ponche1">
                    </div>
                    <input type="submit" class="btn btn-default" value="Capturar">
                    </form>
                </div>
                </div>
        ...
        <!-- Modals -->
        <section class="modal fade" id="addPage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <form>
            <section class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Agregar Tabla</h4>
            </section>
            <div class="modal-body">
                <section class="form-group">
                <label>Título</label>
                <input type="text" class="form-control" placeholder="Agregar Título">
                </section>
                <section class="form-group">
                <label>Texto</label>
                <textarea name="editor1" class="form-control" placeholder="Agregar Texto"></textarea>
                </section>
                ...
                <input type="text" class="form-control" placeholder="Agregar Descripción...">
                </section>
            </div>
