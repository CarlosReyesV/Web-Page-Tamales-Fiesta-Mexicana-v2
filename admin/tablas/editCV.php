            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" class="form-control" placeholder="Page Title" value="Cancelar Venta">
                    </div>
                    <section class="tProductos" style="width:auto; min-width:none">
                        <?php
                        include("tablaCVadm.php");
                        ?>
                    </section>
                    </form>
                    <button><a type="button" href="../insertar/agregarCV.php">Agregar datos</a></button>
                </div>
                </div>
            </div>
            </div>
