            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" class="form-control" placeholder="Page Title" value="Ventas despues del corte">
                    </div>
                    <section class="tProductos" style="width:auto; min-width:none">
                        <?php
                        include("tablaVDCadm.php");
                        ?>
                    </section>
                    </form>
                    <button><a type="button" href="../insertar/agregarVDC.php">Agregar datos</a></button>
                </div>
                </div>
            </div>
            </div>
