        ...
        <div class="areaTabla">
            ...
            <h4>Consulta</h4>
                ...
                if(isset($_GET['search']))
                {
                    ...
                    $query = "SELECT * FROM compra_proveedor WHERE CONCAT(Nombre,Referencia,Fecha,Compra,Numero) LIKE '%$filtervalues%' ";
