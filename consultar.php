        ...
        <div class="areaTabla">
            ...
            <h4>Consulta</h4>
                ...
                if(isset($_GET['search']))
                {
                    ...
                    $query = "SELECT * FROM ajustes WHERE CONCAT(Producto,Motivo_ajuste,Entrada,Salida) LIKE '%$filtervalues%' ";
                ...
                if(mysqli_num_rows($query_run) > 0)
                    {
                        foreach($query_run as $items)
                        {
                            ...
                            <table class='table'>
                                ...
                                <tr>
                                    <td><?= $items['id_ajustes']; ?></td>
                                    <td><?= $items['Producto']; ?></td>
                                    <td><?= $items['Motivo_ajuste']; ?></td>
                                    <td><?= $items['Entrada']; ?></td>
                                    <td><?= $items['Salida']; ?></td>
                                </tr>
                            </table>
                ...
                ?>
                <?php
                    include("bdPHP/conexionCON.php");
                ?>
                <!-- Total del campo de la tabla -->
                <h5>Total entrada:
                    <?php
                        $host="127.0.0.1";
                        $user="empleado1";
                        ...
                        $sql = "SELECT sum(Entrada) FROM ajustes";
                ...
                <h5>Total salida:
                    <?php
                        ...
                        $sql = "SELECT sum(Salida) FROM ajustes";
                        $q = mysqli_query($con, $sql);
                        $row = mysqli_fetch_array($q);
