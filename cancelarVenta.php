        ...
        <div class="areaTabla">
            ...
            <h4>Consulta</h4>
                ...
                if(isset($_GET['search']))
                {
                    ...
                    $query = "SELECT * FROM cancelar_venta WHERE CONCAT(Fecha,Hora,Ticket,Cancelar) LIKE '%$filtervalues%' ";
                ...
                if(mysqli_num_rows($query_run) > 0)
                    {
                        foreach($query_run as $items)
                        {
                            ...
                            <table class='table'>
                                ...
                                <tr>
                                    <td><?= $items['id_cventa']; ?></td>
                                    <td><?= $items['Fecha']; ?></td>
                                    <td><?= $items['Hora']; ?></td>
                                    <td><?= $items['Ticket']; ?></td>
                                    <td><?= $items['Cancelar']; ?></td>
                                </tr>
                            </table>
                            <?php
                        }
