...
<body>
    ...
    <main class="mainpart">
        ...
        <div class="areaTabla">
            <h3>Reporte de ventas después del corte</h3>
            <!-- Boton de busqueda -->
            <div class="folio">
            ...
            <h4>Consulta</h4>
                ...
                if(isset($_GET['search']))
                {
                    ...
                    $query = "SELECT * FROM report_venta_corte WHERE CONCAT(Concepto,Producto,Cantidad,Importe) LIKE '%$filtervalues%' ";
            ...
            <h5>Total de importe:
                    <?php
                        ...
                        $sql = "SELECT sum(importe) FROM report_venta_corte";
